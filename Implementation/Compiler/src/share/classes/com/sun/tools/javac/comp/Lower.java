 ...
 *************************************************************************/
	...
	JCNewClass tree = make.NewClass(null, null,
	    null, null, make.QualIdent(ctype.tsym), args, null);
 ...
 *************************************************************************/
	...
	return rs.resolveInternalMethod(pos, attrEnv, qual, name, args, null, null, null);
    }

    /** Look up a constructor.
     */
    private MethodSymbol lookupConstructor(DiagnosticPosition pos, Type qual, List<Type> args) {
	return rs.resolveInternalConstructor(pos, attrEnv, qual, args, null, null, null);
    }
 ...
 *************************************************************************/
    ...
    public void visitNewClass(JCNewClass tree) {
	if (tree.constructor == null) return; // DPJ FIXME
