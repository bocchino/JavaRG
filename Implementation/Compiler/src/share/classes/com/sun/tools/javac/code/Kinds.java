...
public class Kinds {
    ...
    public final static int ERR = (1 << 7) - 1; // DPJ
    ...
    public static final int ERRONEOUS = 1 << 8; // DPJ
    ...
    public static final int ABSENT_REGION= ERRONEOUS+5; // missing region // DPJ -- adjusted subsequent values
