...
public class Enter extends JCTree.Visitor {
    ...
    public ListBuffer<JCMethodDecl> effectsToAttr = ListBuffer.lb();
	...
	predefClassDef = make.ClassDef(
	    ...
	    syms.predefClass.name, null, null, null, null, null);
 ...
 *************************************************************************/
    ...
    public void visitRegionDecl(DPJRegionDecl tree) { // DPJ -- based on visitVarDef
        ...
        // All field region decls are implicitly static
...
//	System.err.println("entering " + c.fullname + " in " + c.owner);//DEBUG
    ...
    /** Class enter visitor method for region parameters. // DPJ
     *	Enter a symbol for region parameter in local scope, after checking that it
     *	is unique.
     */
