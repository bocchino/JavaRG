...
public class Scope {
    ...
    /** Return the actual scope of a delegated scope
     */
    public Scope getActualScope() { 
	Scope scope = this;
	while (scope instanceof Scope.DelegatedScope) {
	    scope = ((Scope.DelegatedScope) scope).delegatee;
	}
	return scope;
    }
