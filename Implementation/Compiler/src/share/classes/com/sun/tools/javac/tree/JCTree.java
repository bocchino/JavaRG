...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    /** Method permissions
     */
    public static final int METHOD_PERMS = REFPERM + 1;
    
    /** Dereference sets
     */
    public static final int DEREF_SET = METHOD_PERMS + 1;
    ...
    public static class JCSwitch extends JCStatement implements SwitchTree {
        ...
        /** Flag indicating whether this is an instanceof switch */
        public boolean isInstanceofSwitch;
        protected JCSwitch(JCExpression selector, List<JCCase> cases,
        	boolean isInstanceofSwitch) {
            this.selector = selector;
            this.cases = cases;
            this.isInstanceofSwitch = isInstanceofSwitch;
        }
        @Override
	...
	@Override
	public void accept(Visitor v) {
	    v.visitMethodPerms(this);
	}

	@Override
	public <R, D> R accept(TreeVisitor<R, D> v, D d) {
	    return v.visitMethodPerms(this, d);
	}
	...
	@Override
	public void accept(Visitor v) {
	    v.visitDerefSet(this);
	}

	@Override
	public <R, D> R accept(TreeVisitor<R, D> v, D d) {
	    return v.visitDerefSet(this, d);
	}
	...
	@Override
	public void accept(Visitor v) {
	    v.visitEffectPerm(this);
	}

	@Override
	public <R, D> R accept(TreeVisitor<R, D> v, D d) {
	    return v.visitEffectPerms(this, d);
	}
    ...
    public interface Factory {
        ...
        JCSwitch InstanceOfSwitch(JCExpression selector, List<JCCase> cases);
    ...
    public static abstract class Visitor {
        ...
        public void visitEffectPerm(JRGEffectPerm that)    { visitTree(that); }
